const Storage = {
    ...
    initializeSampleData() {
        ...
        const loans = [
            { id: 'loan1', bookId: 'book3', memberId: 'mem1', loanDate: pastDate.toISOString(), returnDate: futureDate.toISOString(), returned: false, actualReturnDate: null, createdAt: now, updatedAt: now },
            { id: 'loan2', bookId: 'book6', memberId: 'mem2', loanDate: pastDate.toISOString(), returnDate: overduePastDate.toISOString(), returned: false, actualReturnDate: null, createdAt: now, updatedAt: now },
            { id: 'loan3', bookId: 'book1', memberId: 'mem3', loanDate: new Date(today.getTime() - 30 * 24 * 60 * 60 * 1000).toISOString(), returnDate: new Date(today.getTime() - 16 * 24 * 60 * 60 * 1000).toISOString(), returned: true, actualReturnDate: new Date(today.getTime() - 17 * 24 * 60 * 60 * 1000).toISOString(), createdAt: now, updatedAt: now }
        ];
